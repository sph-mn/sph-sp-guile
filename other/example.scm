...
(define (seq-example) "creates one block with samples generated by events two times"
  (let*
    ( (events
      ...
      (events-composed
        ; events-new and event groups can be nested and re-nested without restrictions
        (seq-events-new (seq-event-group 0 48000 events)
          (seq-event-group 40000 (+ 48000 40000) events)))
      (series (tail (seq-block-series->list 0 1 1 events-composed #:parallel #t))))
